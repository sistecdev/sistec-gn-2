                        ...
                        ?>
                                <li>
                                    <a href="<?= $n->details_type == "text" ? "#!" : $elseUrl; ?>"
                                        ...
                                        popup-text="<?= $n->detailed_text; ?>" target="_blank">
                                        <div class="date">
        ...
        <div class="row">
                ...
                <div class="counter-card">
                    <div>
                        <div class="counter-icon"> <img
                                src="<?= base_url("assets/web/images/home/counter/years-in-education.png") ?>" alt="">
                        </div>
                    </div>
                    <div class="counter-content">
                        <div class="count-number"> <span class="count ff-semibold" counter-lim="22">22</span> <span
            ...
            <div class="col-md-3">
                <div class="counter-card mt-mob">
                    <div>
                        <div class="counter-icon"> <img
                                src="<?= base_url("assets/web/images/home/counter/skilled-faculties.png") ?>" alt="">
                        </div>
                    </div>
                    <div class="counter-content">
                        <div class="count-number"> <span class="count ff-semibold" counter-lim="2000">2000</span> <span
                                class="plus-sign">+</span> </div>
            ...
            <div class="col-md-3">
                <div class="counter-card mt-mob">
                    <div>
                        <div class="counter-icon"> <img
                                src="<?= base_url("assets/web/images/home/counter/network.png") ?>" alt=""> </div>
                    </div>
                    <div class="counter-content">
            ...
            <div class="col-md-3">
                <div class="counter-card mt-mob">
                    <div>
                        <div class="counter-icon"> <img src="<?= base_url("assets/web/images/home/counter/jobs.png") ?>"
                                alt=""> </div>
                    </div>
                    <div class="counter-content">
                        <div class="count-number"> <span class="count ff-semibold" counter-lim="1100">1100</span> <span
                                class="plus-sign">+</span> </div>
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div>
                            ...
                            <p> The B.Tech. Engineering Program at Sagar Institute of Science and Technology (SISTec)
                                Gandhi Nagar Campus is developed from an industrial point of view, with a great focus on
                                modern technologies employed in the industries. Engineers are the focal point in our
                                economy to design, test, and develop the next generation of products and services for
                                the betterment of society. In this regard, the pedagogy is designed based on
                                industry-oriented training modules a level extra than the standard university
                                curriculum. Similarly, the MTech Engineering Program is developed from a research point
                                of view to inculcate the spirit of innovation and development in Science & Technology.
                            </p>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="course-video right">
                            <div>
                                <div class="shape-div">
                                    <div class="video-div"> <video muted="" loop="" autoplay="" playsinline=""
                                            class="shape-video">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div>
                            ...
                            <p> The MBA Program at Sagar Institute of Science and Technology (SISTec) Gandhi Nagar
                                Campus is the flagship program designed to be a career-building experience for students,
                                developing them into socially responsible and highly skilled managers, and masters in
                                leading their organizations towards excellence. The pedagogy is designed such that
                                students gain exposure to theory and practice alike. The program includes theoretical
                                lectures, audio-visual lectures, case studies, paid/unpaid internships, learning through
                                events & activities, and lab-based learning. Students receive a foundational level of
                                MBA education with a great focus on the key management disciplines, subjects, and
                                issues.</p>
                        </div>
                        <div class="course-content-row">
                            <div class="row">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="swiper-sync-cards-container">
                    ...
                    <button onclick="moveCardSyncSliderPrev()"
                        class="btn btn-outline-dark swiper-sync-card-btn prev-btn">
                        <i class="fas fa-arrow-left"></i>
                    </button>
                    <button onclick="moveCardSyncSliderNext()"
                        class="btn btn-outline-dark swiper-sync-card-btn next-btn">
                ...
                <div>
                    <div class="our-recruiters-slider">
                        ...
                        <div class="recruiter-card">
                            <div class="img-div">
                                <img src="<?= base_url('assets/web/images/home/recruiters/') ?>C<?= $i; ?>.jpg"
                                    class="recruiter-logo box-shadow-2">
                            </div>
                        </div>
                        <?php } ?>
                    </div>
