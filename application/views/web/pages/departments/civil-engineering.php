                              ...
                              <div class="faculty-card">
                                 ...
                                 <div class="faculty-card-content space-y-3">
                                    <div>
                                       ...
                                       <p class="d-none" id="ce<?= $i; ?>qualification"><?= $faculty["qualification"]; ?></p>
                                       <p class="d-none" id="ce<?= $i; ?>industrial"><?= $faculty["industrial-experience"]; ?></p>
                                       <p class="d-none" id="ce<?= $i; ?>teaching"><?= $faculty["teaching-experience"]; ?></p>
                                       <p class="d-none" id="ce<?= $i; ?>specialization"><?= $faculty["specialization"]; ?></p>
                                       <p class="d-none" id="ce<?= $i; ?>association"><?= $faculty["association"]; ?></p>
                                    </div>
                                    <a href="#!" class="web__btn__two" data-bs-toggle="modal" data-bs-target="#departmentFacultyModal" data-facid="ce<?= $i; ?>" onclick="showFacultyDetailsInFacultyModal(this)">
                                       Know More
                                    </a>
                                 </div>
                              </div>
