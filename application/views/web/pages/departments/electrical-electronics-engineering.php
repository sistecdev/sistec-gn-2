               ...
               <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="tab-pane fade" id="about-peo" role="tabpanel" aria-labelledby="about-peo-tab">
                           <div>
                              ...
                              <div class="dept-content">
                                 <table class="table">
                                    <tbody>
                                       <?php foreach ($departmentPEO["ex"] as $deptPeoKey => $deptPeoValue) { ?>
                                          <tr>
                                             <th><?= $deptPeoKey; ?></th>
                                             <td><?= $deptPeoValue; ?></td>
                                          </tr>
                        ...
                        <div class="tab-pane fade" id="about-pso" role="tabpanel" aria-labelledby="about-pso-tab">
                           <div>
                              ...
                              <div class="dept-content">
                                 <table class="table">
                                    <tbody>
                                       <?php foreach ($departmentPSO["ex"] as $deptPsoKey => $deptPsoValue) { ?>
                                          <tr>
                                             <th><?= $deptPsoKey; ?></th>
                                             <td><?= $deptPsoValue; ?></td>
                                          </tr>
                  ...
                  <div class="tab-pane fade" id="v-pills-programs" role="tabpanel" aria-labelledby="v-pills-programs-tab">
                     ...
                     <div class="tab-content mt-3" id="nav-tabContent">
                        ...
                        <div class="tab-pane fade" id="pg-vision" role="tabpanel" aria-labelledby="pg-vision-tab">
                           <div class="space-y-8">
                              <div>
                                 <h2 class="title">M.Tech. Digital Communication <br> Current Intake : 18</h2>
                                 <div class="dept-content">
                                    <p>
                                       M. Tech. in Digital Communication is typically a 2-year postgraduate level degree program, divided into 4 semesters. It is a course program focusing on both theoretical & practical aspects to students in communication & networking areas.
                                       This PG-level course aims at producing trained professionals who can successfully deal with fulfilling the exact market demands. Nowadays the telecommunication industry has been extremely speedily growing compared to any other industry across the country.
                                    </p>
                                    <table class="table table-striped">
                                       <thead>
                                          <tr>
                              ...
                              <div>
                                 ...
                                 <div class="dept-content">
                                    <div class="space-y-4">
                                       <p>
                                          M.Tech in VLSI Design is a two-year postgraduate programme that aims to impart knowledge of VLSI system design, covering algorithms, hardware description languages, system architectures, physical designs, verification techniques, simulation and synthesis, low power design techniques etc.
                                       </p>
                                       <p>
                                          The recent advancements in VLSI design have enabled most systems to become compact and reliable and to deliver data at high speed. With the advent of VLSI designs, the number of applications of integrated circuits (ICs) in high-performance computing, controls, telecommunications, image and video processing, and consumer electronics has been rising at a fast pace. Therefore, there is good scope and high demand for engineers in the fast-changing chip designing industry.
                                       </p>
                                    </div>
                                    <table class="table table-striped">
                                       <thead>
                  ...
                  <div class="tab-pane fade" id="v-pills-faculty" role="tabpanel" aria-labelledby="v-pills-faculty-tab">
                     <div class="space-y-5">
                        ...
                        <div class="faculty-cards-flex">
                           <?php for ($i = 0; $i < count($departmentFaculties["ec"]); $i++) {
                              $faculty =
                                 $departmentFaculties["ec"][$i]; ?>
                              <div class="faculty-card">
                                 <img src="<?= base_url() . $faculty["image"]; ?>">
                                 <div class="faculty-card-content space-y-3">
                                    <div>
                                       <p class="font-bold" id="ec<?= $i; ?>name"><?= $faculty["name"]; ?></p>
                                       <p id="ec<?= $i; ?>designation"><?= $faculty["designation"]; ?></p>
                                       <p class="d-none" id="ec<?= $i; ?>about"><?= $faculty["about"]; ?></p>
                                       <p class="d-none" id="ec<?= $i; ?>qualification"><?= $faculty["qualification"]; ?></p>
                                       <p class="d-none" id="ec<?= $i; ?>industrial"><?= $faculty["industrial-experience"]; ?></p>
                                       <p class="d-none" id="ec<?= $i; ?>teaching"><?= $faculty["teaching-experience"]; ?></p>
                                       <p class="d-none" id="ec<?= $i; ?>specialization"><?= $faculty["specialization"]; ?></p>
                                       <p class="d-none" id="ec<?= $i; ?>association"><?= $faculty["association"]; ?></p>
                                    </div>
                                    <a href="#!" class="web__btn__two" data-bs-toggle="modal" data-bs-target="#departmentFacultyModal" data-facid="ec<?= $i; ?>" onclick="showFacultyDetailsInFacultyModal(this)">
                                       Know More
                                    </a>
                                 </div>
                              </div>
                        ...
                        <table class="table table-striped">
                           ...
                           <tbody>
                              ...
                              <tr>
                                 ...
                                 <td class="text-center w-50">
                                    Completed Entrepreneurship Quiz-2019 organized by Ministry of skill development & Entrepreneurship
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td class="text-center w-50">
                                    Presented Paper on title "Internet of Things, its applications and problems yet to face" in 2nd International Conference on Intelligent Data Communication Technologies and Internet of Things
                                 </td>
                              </tr>
                              <tr>
                  ...
                  <div class="tab-pane fade" id="v-pills-laboratories" role="tabpanel" aria-labelledby="v-pills-laboratories-tab">
                     ...
                     <div class="projects-cards-grid">
                        <div class="projects-card">
                           <h1 class="project-card-title">Basic Electrical and Electronics Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Computer Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Control System Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Electrical Drives Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Electrical Instrumentation Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Electronics Instrumentation Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Machine-1 Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Machine-2 Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                        ...
                        <div class="projects-card">
                           <h1 class="project-card-title">Power Electronics Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Power System Protection Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Power System-1 Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                        <div class="projects-card">
                           <h1 class="project-card-title">Project Lab</h1>
                           <img src="<?= base_url("assets/admin/upload/projects/ec/Automatic-Hand-Sanitizer.png"); ?>">
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="tab-pane fade" id="v-pills-newsletters" role="tabpanel" aria-labelledby="v-pills-newsletters-tab">
                     ...
                     <div class="newsletter-cards-grid">
                        <?php $i = 0;
                        foreach ($departmentNewsletters["ex"] as $deptNewsLetterKey => $deptNewsLetterValue) {
                           $i++; ?>
