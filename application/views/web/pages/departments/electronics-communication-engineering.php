                        ...
                        <div class="tab-pane fade" id="about-peo" role="tabpanel" aria-labelledby="about-peo-tab">
                           <div>
                              ...
                              <div class="dept-content">
                                 <table class="table">
                                    <tbody>
                                       <?php foreach ($departmentPEO["ece"] as $deptPeoKey => $deptPeoValue) { ?>
                                          <tr>
                                             <th><?= $deptPeoKey; ?></th>
                                             <td><?= $deptPeoValue; ?></td>
                                          </tr>
                        ...
                        <div class="tab-pane fade" id="about-pso" role="tabpanel" aria-labelledby="about-pso-tab">
                           <div>
                              ...
                              <div class="dept-content">
                                 <table class="table">
                                    <tbody>
                                       <?php foreach ($departmentPSO["ece"] as $deptPsoKey => $deptPsoValue) { ?>
                                          <tr>
                                             <th><?= $deptPsoKey; ?></th>
                                             <td><?= $deptPsoValue; ?></td>
                                          </tr>
                              ...
                              <div class="dept-content">
                                 <div class="table-responsive">
                                    <table class="table table-striped table-bordered rnd-projects-table">
                                       ...
                                       <tbody>
                                          <?php $i = 0;
                                          foreach ($ugcjournals as $m) {
                                             $i++; ?>
                                             <tr class="text-center align-middle">
                                                <td class="text-center"><?= $i; ?></td>
                                                <td class="text-center"><?= $m->title; ?></td>
                                                <td class="text-center"><?= $m->author_name; ?></td>
                                                <td class="text-center"><?= $m->journal_name; ?></td>
                                                <td class="text-center"><?= $m->year; ?></td>
                                                <td class="text-center"><?= $m->isbn; ?></td>
                                                <td class="text-center"><?= $m->link; ?></td>
                                             </tr>
                                          <?php } ?>
                                       </tbody>
                                    </table>
